...
set_property PACKAGE_PIN R2 [get_ports _pause]					
...
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {SCLK1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SCLK1}]
#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {SS2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SS2}]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {MOSI2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MOSI2}]
#Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {MISO2}]					
...
#Pmod Header JB
#Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {SS3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SS3}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {MOSI3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MOSI3}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {MISO3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MISO3}]
#Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {SCLK3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SCLK3}]
#Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {SS4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SS4}]
#Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {MOSI4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MOSI4}]
#Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {MISO4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MISO4}]
#Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {SCLK4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SCLK4}]
